...
export default function UpdateTransactionModal({
  ...
  // Populate state whenever target transaction changes
  useEffect(() => {
    if (transaction) {
      ...
      setFormData({
        ...
        budgetId: transaction.budgetId ? String(transaction.budgetId) : "",
        goalId: transaction.goalId ? String(transaction.goalId) : "",
      });
    }
  }, [transaction]);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      payload.append("budgetId", formData.budgetId);
      payload.append("goalId", formData.goalId);
        ...
        <div className="flex flex-col gap-3 mt-5">
          ...
          <div className="group flex flex-col gap-2">
            <div className="flex justify-between items-center gap-2">
              ...
              <Label
                className={`isfilled-badge ${
                  fieldStatus.description ? "badge-success" : "badge-destructive"
                }`}
              >
            ...
            <Input
              ...
              className={`h-11 ${
                fieldStatus.description ? "focus-visible:ring-success border-success/30" : ""
              }`}
            />
          </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div className="group flex flex-col gap-2">
              ...
              <Input
                ...
                onChange={handleChange}
                className={`h-11 ${
                  fieldStatus.date ? "focus-visible:ring-success border-success/30" : ""
                }`}
              />
            </div>
          </div>
          ...
          <div className="grid grid-cols-3 gap-3">
            ...
            <div className="group flex flex-col gap-2">
              <div className="flex justify-between items-center gap-2">
                ...
                <Label
                  className={`isfilled-badge ${
                    fieldStatus.budgetId ? "badge-success" : "badge-destructive"
                  }`}
                >
            ...
            <div className="group flex flex-col gap-2">
              <div className="flex justify-between items-center gap-2">
                ...
                <Label
                  className={`isfilled-badge ${
                    fieldStatus.goalId ? "badge-success" : "badge-destructive"
                  }`}
                >
                  {fieldStatus.goalId ? (
                    <BadgeCheck className="w-3.5 h-3.5 stroke-[2.5]" />
