...
#### Installing Database Dependancies
```bash
...
#### Generate and Push Your Database Tables
```bash
...
export const authClient = createAuthClient({
    baseURL: process.env.NEXT_PUBLIC_APP_URL || "http://localhost:3000", // <-- Explicitly add this line
    plugins: [
        usernameClient(),
    ]
});
